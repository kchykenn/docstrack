...
import { X, Save, FileText, MapPin, CheckCircle } from "lucide-react"
      ...
      <DialogContent className="sm:max-w-4xl top-4 !translate-y-0" onInteractOutside={(e) => e.preventDefault()}>
        ...
        {step === 3 && (
          <div className="text-center mt-10">
            ...
            <h2 className="text-lg font-bold mb-2">Are you sure you want to route this document?</h2>
            <p className="text-gray-600 mb-6">Please confirm your submission.</p>
            <DialogFooter className="flex justify-center gap-4">
              <Button variant="outline" onClick={handleBackStep}>Back</Button>
              <Button onClick={handleSubmit} className="bg-blue-600 text-white">Yes, Route Document</Button>
            </DialogFooter>
          </div>
        )}
      </DialogContent>
